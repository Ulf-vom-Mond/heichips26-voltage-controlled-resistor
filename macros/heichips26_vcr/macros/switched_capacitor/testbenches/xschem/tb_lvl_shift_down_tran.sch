...
C {devices/vsource.sym} 800 -790 0 0 {name=VDD value=1.2}
...
C {devices/vsource.sym} 1240 -770 0 1 {name=vin value="PULSE(0 3.3 \{period/8\} \{period/1000\} \{period/1000\} \{period/2\} \{period\})"
}
...
C {hv_inverter_40u.sym} 1440 -840 0 0 {name=x1}
