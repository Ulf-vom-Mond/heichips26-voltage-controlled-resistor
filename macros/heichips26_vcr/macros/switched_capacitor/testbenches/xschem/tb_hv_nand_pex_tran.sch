...
only_toplevel=true 
value="
.include ../../../netlist/pex/hv_nand_magic_pex_3.spice
.param VDD=3.3
.csparam VDD=VDD
.param Vcm=VDD/2
.param temp=27
...
C {devices/vsource.sym} 1420 -890 0 1 {name=vp1 value="PULSE(0 VDD \{tdel\} \{tr\} \{tf\} \{period*2\} \{period*4\})"
}
...
C {hv_nand_pex.sym} 1820 -820 0 0 {name=x4}
