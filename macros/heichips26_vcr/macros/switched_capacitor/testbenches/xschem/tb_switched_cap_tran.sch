...
N 1200 -660 1320 -660 {lab=vctrl}
N 1460 -560 1460 -540 {lab=VSS}
N 1460 -640 1460 -620 {lab=#net1}
N 1440 -640 1460 -640 {lab=#net1}
...
N 1200 -660 1200 -640 {lab=vctrl}
N 1100 -660 1200 -660 {lab=vctrl}
N 1440 -680 1540 -680 {lab=vr}
...
.endc
"}
C {devices/vsource.sym} 1000 -610 0 0 {name=VDD value=\{VDD\}}
...
C {lab_pin.sym} 1460 -680 3 0 {name=p3 sig_type=std_logic lab=vr
}
...
C {lab_pin.sym} 1200 -660 1 0 {name=p4 sig_type=std_logic lab=vctrl}
