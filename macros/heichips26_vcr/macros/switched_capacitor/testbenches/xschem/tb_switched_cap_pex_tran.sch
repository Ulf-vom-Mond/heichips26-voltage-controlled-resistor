...
N 1380 -660 1400 -660 {lab=VSS}
N 1460 -660 1580 -660 {lab=#net2}
...
C {isource.sym} 1280 -610 0 0 {name=I0 value=1u
spice_ignore=true}
...
C {code_shown.sym} 1320 -790 0 0 {value="
.ic v(x1.osc_0.c1)=0
"
}
C {ammeter.sym} 1430 -660 1 1 {name=victrl savecurrent=true }
