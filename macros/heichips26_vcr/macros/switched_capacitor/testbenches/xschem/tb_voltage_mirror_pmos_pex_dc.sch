...
N 1280 -820 1280 -800 {lab=GND}
N 1280 -900 1280 -880 {lab=#net1}
C {devices/code_shown.sym} 40 -1630 0 0 {name=NGSPICE
only_toplevel=true 
value="
.include ../../../netlist/pex/voltage_mirror_pmos_magic_pex_3.spice
.param VDD = 3.3
.param temp=27
...
C {devices/lab_pin.sym} 1400 -980 0 1 {name=l11 sig_type=std_logic lab=out}
C {devices/gnd.sym} 1320 -900 0 0 {name=l14 lab=GND
w=n_w}
C {isource.sym} 1280 -850 0 0 {name=I0 value=10u}
C {devices/gnd.sym} 1280 -800 0 0 {name=l3 lab=GND
w=n_w}
C {voltage_mirror_pmos_pex.sym} 1320 -960 0 0 {name=x1}
