...
N 100 20 100 160 {lab=in3}
N 100 160 120 160 {lab=in3}
N -120 160 -40 160 {lab=in4}
N -100 20 100 20 {lab=in3}
N -160 -20 -120 -20 {lab=in4}
N -120 -20 -120 160 {lab=in4}
...
N 260 60 260 160 {lab=in2}
N 260 160 280 160 {lab=in2}
N 320 160 320 220 {lab=VSS}
N 160 0 320 0 {lab=out}
N 480 0 480 130 {lab=out}
N 420 100 420 160 {lab=in1}
N 420 160 440 160 {lab=in1}
N 480 160 480 220 {lab=VSS}
N 320 0 480 0 {lab=out}
N -80 60 260 60 {lab=in2}
...
N -60 100 420 100 {lab=in1}
N -60 -40 -60 100 {lab=in1}
N -80 -120 -40 -120 {lab=in2}
N -160 100 -60 100 {lab=in1}
N -100 -200 -40 -200 {lab=in3}
N -120 -280 -120 -20 {lab=in4}
N -120 -280 -40 -280 {lab=in4}
N 0 -340 0 -310 {lab=VDD}
N 0 -280 100 -280 {lab=VDD}
N 100 -340 100 -280 {lab=VDD}
N -80 -120 -80 60 {lab=in2}
N -160 60 -80 60 {lab=in2}
N -100 -200 -100 20 {lab=in3}
N -160 20 -100 20 {lab=in3}
C {devices/ipin.sym} -160 100 0 0 {name=p10 lab=in1}
...
C {devices/ipin.sym} -160 60 0 0 {name=p2 lab=in2}
...
C {devices/ipin.sym} -160 20 0 0 {name=p12 lab=in3}
C {devices/ipin.sym} -160 -20 0 0 {name=p13 lab=in4}
