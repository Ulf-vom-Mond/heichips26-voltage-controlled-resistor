...
C {iopin.sym} 230 -220 2 0 {name=p8 lab=vin2
}
C {lab_pin.sym} 420 -100 3 0 {name=p4 sig_type=std_logic lab=vss}
...
C {sg13cmos5l_pr/rhigh.sym} 290 -220 1 0 {name=R3
w=2e-6
l=100e-6
model=rhigh
body=vss
...
C {sg13cmos5l_pr/rhigh.sym} 420 -160 2 0 {name=R4
w=2e-6
l=100e-6
model=rhigh
body=vss
